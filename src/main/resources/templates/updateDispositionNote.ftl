...
<body>
<h2>Update disposition Note</h2>
<form name="opportunity" action="/updateDispositionNote" method="post">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td><label>:</label></td>
            <td><label><input type="text" name="disposition" value="${opportunity.disposition}" disabled="true"></label><br></td>
